...
//draw_sprite_part_ext(sLevel1Outline_1,0,_left,0,diff_x2,diff_y3,x,y,x_scale,y_scale,c_aqua,1);

draw_sprite_ext(oPathFullLevel1_14,0,x,y,x_scale,y_scale,0,c_aqua,1);
